...
if (isset($_POST['supplier_id'])) {
  ...
  $sql = "SELECT * FROM ingredients_supplier WHERE supplier_id = '$supplier_id'";
  $result = mysqli_query($conn, $sql);

  if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
      ?>
      <div class="modal fade" id="fetchDataSupplierDetailsModal" tabindex="-1" role="dialog"
        aria-labelledby="requestModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Ingredients Supplier Details ID: <?php echo $row['supplier_id']; ?></h5>
                ...
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="supplier_name" name="supplier_name"
                      placeholder="Enter Supplier Name" value="<?php echo $row['supplier_name']; ?>" readonly required>
                  </div>
                  <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="landline" name="landline" placeholder="Enter Landline"
                      value="<?php echo $row['landline']; ?>" readonly required>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="mobile_number" name="mobile_number" placeholder="Enter Mobile"
                      value="<?php echo $row['mobile_number']; ?>" readonly required>
                  </div>
                  <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="tin" name="tin" placeholder="Enter TIN"
                      value="<?php echo $row['tin']; ?>" readonly required>
                  </div>
                </div>
              </form>
            </div>
