...
<div class="modal fade" id="addTagAsPaid" tabindex="-1" role="dialog" aria-labelledby="addTagAsPaidLabel" aria-hidden="true">
  <div class="modal-dialog modal-l" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addTagAsPaidLabel">Deliveries</h5>
...
<script>
  $(document).ready(function() {
    $('#addTagAsPaid form').submit(function(event) {
      ...
      $.ajax({
        type: 'POST',
        url: '/online_ordering/controllers/admin/tag_as_paid_process.php',
        data: formData,
