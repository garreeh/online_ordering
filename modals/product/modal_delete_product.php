...
?>
      <div class="modal fade" id="deleteProductModal" tabindex="-1" role="dialog" aria-labelledby="requestModalLabel" aria-hidden="true">
...
<script>
  $(document).ready(function() {
    $('#deleteProductModal form').submit(function(event) {
      ...
      $.ajax({
        type: 'POST',
        url: '/online_ordering/controllers/admin/delete_product_process.php',
        data: formData,
