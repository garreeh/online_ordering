  ...
  <div class="main">
    <div class="container">
      ...
      <div class="row margin-bottom-40">
        ...
        <div class="col-md-12 col-sm-8 col-xs-7 special-product">
          <?php
          $sql = "SELECT * FROM product WHERE product_type = 'Booking'";
          ...
          ?>
              <div class="col-xs-12 col-sm-6 col-md-3" style="margin-bottom: 2rem;">
                <a href="booking_details.php?product_id=<?php echo $product_id; ?>" target="_blank">
