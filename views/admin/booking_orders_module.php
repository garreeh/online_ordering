            ...
            <div class="col-xl-12 col-lg-12">
              <div class="tab-pane fade show active" id="aa" role="tabpanel" aria-labelledby="aa-tab">
                ...
                <div class="table-responsive">
                  ...
                  <table class="table custom-table table-hover" name="booking_orders_table" id="booking_orders_table">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Product Name</th>
...
<script>
  $('#sidebarToggle').click(function() {
    $('#booking_orders_table').css('width', '100%');
    // console.log(table) //This is for testing only
  });

  //Table for Transactions
  $(document).ready(function() {
    var booking_orders_table = $('#booking_orders_table').DataTable({
      "pagingType": "numbers",
      "processing": true,
      "serverSide": true,
      "ajax": "./../../controllers/tables/booking_orders_table.php",
    });

    window.reloadDataTable = function() {
      booking_orders_table.ajax.reload();
    };
  ...
  $(document).ready(function() {
    ...
    $('#booking_orders_table').on('click', 'tr td:nth-child(7) .ProofData', function() {
  ...
  $(document).ready(function() {
    // Function to handle click event on datatable rows
    $('#booking_orders_table').on('click', 'tr td:nth-child(9) .fetchDataDelivery', function() {
      var cart_id = $(this).closest('tr').find('td').first().text(); // Get the cart_id from the clicked row
