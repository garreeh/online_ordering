...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <?php include './../../modals/product/modal_add_booking_product.php'; ?>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Booking Module</h1>
          </div>

          <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm mb-4" data-toggle="modal"
            data-target="#addProductBookingModal"> <i class="fas fa-plus"></i> Add Booking Products</a>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="tab-pane fade show active" id="aa" role="tabpanel" aria-labelledby="aa-tab">
                ...
                <div class="table-responsive">
                  ...
                  <table class="table custom-table table-hover" name="booking_product_table" id="booking_product_table">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>SKU</th>
...
<script>
  $('#sidebarToggle').click(function() {
    $('#booking_product_table').css('width', '100%');
    // console.log(table) //This is for testing only
  });

  //Table for Product
  $(document).ready(function() {
    var booking_product_table = $('#booking_product_table').DataTable({
      "pagingType": "numbers",
      "processing": true,
      "serverSide": true,
      "ajax": "./../../controllers/tables/booking_product_table.php",
    });

    window.reloadDataTable = function() {
      booking_product_table.ajax.reload();
    };
  ...
  $(document).ready(function() {
    ...
    $('#booking_product_table').on('click', 'tr td:nth-child(4) .fetchDataProductImage', function() {
  ...
  $(document).ready(function() {
    // Function to handle click event on datatable rows
    $('#booking_product_table').on('click', 'tr td:nth-child(5) .fetchDataProduct', function() {
      var product_id = $(this).closest('tr').find('td').first().text(); // Get the product_id from the clicked row

      $.ajax({
        url: './../../modals/product/modal_edit_booking_product.php', // Path to PHP script to fetch modal content
        method: 'POST',
        data: {
          product_id: product_id
        },
  ...
  $(document).ready(function() {
    // Function to handle click event on datatable rows
    $('#booking_product_table').on('click', 'tr td:nth-child(5) .fetchDataProductDelete', function() {
      var product_id = $(this).closest('tr').find('td').first().text(); // Get the product_id from the clicked row
