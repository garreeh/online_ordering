...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <?php include './../../modals/product/modal_add_ingredients_product.php'; ?>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ingredients Module</h1>
          </div>

          <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm mb-4" data-toggle="modal"
            data-target="#addProductModal"> <i class="fas fa-plus"></i> Add Ingredients</a>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="tab-pane fade show active" id="aa" role="tabpanel" aria-labelledby="aa-tab">
                ...
                <div class="table-responsive">
                  ...
                  <div id="modalContainerProductWithdraw"></div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#ingredients_product_table').on('click', 'tr td:nth-child(5) .fetchDataProduct', function() {
      ...
      $.ajax({
        url: './../../modals/product/modal_edit_ingredients_product.php', // Path to PHP script to fetch modal content
        method: 'POST',
        data: {
  ...
  $(document).ready(function() {
    ...
    $('#ingredients_product_table').on('click', 'tr td:nth-child(5) .fetchDataProductDelete', function() {
      ...
      $.ajax({
        url: './../../modals/product/modal_delete_ingredients_product.php', // Path to PHP script to fetch modal content
        method: 'POST',
        data: {
          product_id: product_id
        },
  ...
  $(document).ready(function() {
    ...
    $('#ingredients_product_table').on('click', 'tr td:nth-child(5) .fetchDataProductManualWithdraw', function() {
      ...
      $.ajax({
        url: './../../modals/product/modal_withdraw_ingredients_product.php', // Path to PHP script to fetch modal content
        method: 'POST',
        data: {
          product_id: product_id
        },
