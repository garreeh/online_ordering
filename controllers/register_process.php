                            ...
                            <body>
                                <div class='email-container'>
                                    ...
                                    <div class='email-body'>
                                        ...
                                        <a href='https://J & J-ordering.online/online_ordering/controllers/verification_process.php?email=" . $user_email . "' class='verify-button'>Verify Email</a>
                                        <p>If you did not sign up for this account, please disregard this email.</p>
                                        <p>Best Regards,<br>J & J</p>
                                    </div>
                                    <div class='email-footer'>
                                        &copy; 2024 J & J. All rights reserved.
                                    </div>
                                </div>
                            </body>
                            </html>";
